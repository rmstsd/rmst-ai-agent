...
本文档用于 `m4-entity` Skill 通过终端查询、创建和修改 M4 业务对象。

## 1. 接口概览

| 操作 | 方法 | 接口 | 说明 |
| --- | --- | --- | --- |
| 创建业务对象 | `POST` | `/api/meta/entity` | 提交完整业务对象配置 |
| 修改业务对象 | `POST` | `/api/meta/entity` | 提交修改后的完整业务对象配置 |
...
使用 `POST /api/meta/entity`，请求体是完整的业务对象配置。接口返回 HTTP `200` 表示保存成功。

终端脚本调用方式：

```bat
skill\m4-entity1\scripts\m4-entity.bat save <json文件路径>
```
...
```bat
skill\m4-entity1\scripts\m4-entity.bat get <业务对象名>
```

### 查询全部业务对象

```bat
skill\m4-entity1\scripts\m4-entity.bat list
```
